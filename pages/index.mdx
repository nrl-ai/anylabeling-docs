---
title: AnyLabeling - Easy AI for Everyone
---
      ...
      <Features>
        ...
        <Feature index={1} centered className="card-with-border" href="/docs">
          <div className="h-full flex flex-col justify-start">
            ...
            <p className='text-center mb-4'>Install With Pip</p>
            <div>
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-4">
                  <code>{`pip install anylabeling`}</code>
                </div>
              </div>
            </div>
            <p className='text-center mb-4'>Start Labeling</p>
            <div>
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-4">
                  <code>{`anylabeling`}</code>
                </div>
              </div>
              <p className="subtitle">
