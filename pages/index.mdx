...
<div className="home-content">
  <div className="content-container">
    ...
    <div className="flex flex-col items-center gap-4 max-w-2xl mt-6">
      <a href="https://anylearning.nrl.ai/" target="_blank" rel="noopener noreferrer">
        <img className="w-full rounded-2xl" src="https://github.com/user-attachments/assets/c2de3534-3e04-439b-bdca-19f6fcb9fc61" alt="AnyLearning-Banner" />
      </a>
    </div>
  </div>
